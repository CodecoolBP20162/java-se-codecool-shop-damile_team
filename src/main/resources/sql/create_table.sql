...
INSERT INTO products(productId, name, defaultPrice, currencyString, description, productCategoryId, supplierId) VALUES (4, 'Iphone 7', 649, 'USD', 'Keyboard cover is included. Fanless Core m5 processor. Full-size USB ports. Adjustable kickstand.', 2, 4);
